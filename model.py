...
from next_model.convnext import convnext_tiny
...
class GazeLSTM(nn.Module):
    def __init__(self):
        ...
        self.img_feature_dim = 1000  # the dimension of the CNN feature to represent each frame

        self.base_model = convnext_tiny(pretrained=True)
